...
const { createBooking, getAllBookings, getBookingById, updateBookingStatus, assignTechnician, deleteBooking, getBookingStats, exportBookingsCsv } = require('../controllers/bookingController');
...
router.get('/export/csv', protect, adminOnly, exportBookingsCsv);
