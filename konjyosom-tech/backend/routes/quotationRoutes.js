...
const { createQuotation, getAllQuotations, getQuotationById, updateQuotation, deleteQuotation, getQuotationStats, exportQuotationsCsv } = require('../controllers/quotationController');
const { protect, adminOnly } = require('../middleware/auth');

router.post('/', createQuotation);
router.get('/', protect, adminOnly, getAllQuotations);
router.get('/stats/overview', protect, adminOnly, getQuotationStats);
router.get('/export/csv', protect, adminOnly, exportQuotationsCsv);
